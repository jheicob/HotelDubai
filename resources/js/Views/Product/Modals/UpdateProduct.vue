            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button :disabled="useHelper.desactiveButton" v-on:click.prevent="useStore.putRoomType()"
                            class="btn btn-primary text-white btn-icon-split mb-4">
                            <span class="text font-montserrat font-weight-bold">Modificar Producto</span>
                        </button>
                    </div>
                </div>
            </div>
