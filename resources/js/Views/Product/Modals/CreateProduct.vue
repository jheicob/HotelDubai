            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="number" min="0" id="name" class="form-control form-control-user mb-3"
                                    autofocus name="purchase_price" v-model="useHelper.form.purchase_price" />

                            </div>
                            <div class="col">
                                <label for="sale_price" class="form-label">Precio Venta</label>
                                <input type="number" min="0" id="sale_price" class="form-control form-control-user mb-3"
                                    autofocus name="name" v-model="useHelper.form.sale_price" />
                            </div>

                        </div>
                        <div class="row">
                            <div class="col">
                                <label for="stock" class="form-label">Disponibles</label>
                                <input class="form-control" id="stock" type='number' min="0"
                                    v-model="useStore.inventory.stock" />
                            </div>
                            <div class="col">
                                <label for="stock_min" class="form-label">Stock Mínimo</label>
                                <input class="form-control" id="stock_min" type='number' min="0"
                                    v-model="useStore.inventory.stock_min" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-check form-switch form-check-reverse text-center">

                                <label for="visible" class="form-check-label mx-3">¿Aparecerá en la factura? </label>
                                <input class="form-check-input" id="visible" type="checkbox" role="switch"
                                    v-model="useHelper.form.visible" />
                    ...
                    <div class="modal-footer">
                        ...
                        <button :disabled="useHelper.desactiveButton" v-on:click.prevent="useStore.storeRoomType()"
                            class="btn btn-primary text-white btn-icon-split mb-4">
                            <span class="text font-montserrat font-weight-bold">Crear Producto</span>
                        </button>
                    </div>
                </div>
            </div>
